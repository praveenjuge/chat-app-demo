...
function prepHTML(options) {
  ...
  appendCSS(relative_path + "/styles/input.css")
  appendCSS(relative_path + "/styles/reply.css")
  appendCSS(relative_path + "/styles/says.css")
  appendCSS(relative_path + "/styles/setup.css")
  appendCSS(relative_path + "/styles/typing.css")
}
